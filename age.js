...
function age() {
    ...
    if ((uAge.length > 2 && uAge.length !== 4) || uAge.length === 0 || uAge.parseInt > currentYear || typeof (parseInt(uAge)) === 'undefined') {
    ...
    console.log();
    if (((uAge.length <= 2 && parseInt(uAge)) >= 1 && (parseInt(uAge) < 16)) || (uAge.length === 4 && (currentYear - parseInt(uAge) <= 16))) {
